...
export const hrDelegationService = {
  async getPaged(query: DelegationQuery): Promise<PagedDelegations> { const { data } = await apiClient.get<PagedDelegations>('/hr/delegations', { params: { page: query.page, pageSize: query.pageSize, search: query.search || undefined, employeeId: query.employeeId || undefined, departmentId: query.departmentId || undefined, delegationTypeId: query.delegationTypeId || undefined, delegatingEntityId: query.delegatingEntityId || undefined, status: query.status || undefined, dateFrom: query.dateFrom || undefined, dateTo: query.dateTo || undefined, sortBy: query.sortBy, sortDirection: query.sortDirection } }); return data; },
