...
public sealed class DelegationType
{
    private DelegationType() { }

    public DelegationType(string name, string code, DateTimeOffset createdAt)
        : this(name, code, null, null, true, createdAt)
    {
    }

    public DelegationType(string name, string code, string? nameArabic, string? description, bool isActive, DateTimeOffset createdAt)
    {
