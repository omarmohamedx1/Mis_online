...
public sealed class ContractType
{
    ...
    public ContractType(string name, string code, DateTimeOffset createdAt)
        : this(name, code, null, null, true, createdAt)
    {
    }

    public ContractType(string name, string code, string? nameArabic, string? description, bool isActive, DateTimeOffset createdAt)
    {
